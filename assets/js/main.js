...
(function() {
  ...
  const typed_technologies = document.querySelector('.typed_technologies');
  if (typed_technologies) {
    let typed_strings = typed_technologies.getAttribute('data-typed-items');
    typed_strings = typed_strings.split(',');
    new Typed('.typed_technologies', {
      strings: typed_strings,
      loop: true,
      typeSpeed: 100,
      backSpeed: 50,
